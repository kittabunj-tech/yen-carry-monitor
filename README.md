...
## Episode Explorer (Phase 6E)

หน้า **[episodes.html](https://kittabunj-tech.github.io/yen-carry-monitor/site/episodes.html)** —
เลือกเหตุการณ์ unwind ในอดีต 6 ครั้ง (COVID 2020 / BOJ YCC 2022 / intervention
เม.ย. 2024 / unwind ส.ค. 2024 / risk-off ก.พ. 2025, ม.ค. 2026) แล้ว replay
ว่าตัวชี้วัด 8 ตัวขยับอย่างไร **ก่อน / ระหว่าง / หลัง** (หน้าต่าง −60 → +40 วันทำการ
ราคา normalize = 100 ณ day 0) พร้อม scrubber เลื่อนดูค่าทุกตัว ณ วันใดก็ได้

ข้อมูลจาก `data/episodes.json` — static, generate ครั้งเดียวด้วย
`python backtest/build_episodes.py` (ข้อมูลอดีตไม่เปลี่ยน ไม่ต้องเข้า workflow)
เพิ่มเหตุการณ์ใหม่ที่ `episodes.list` ใน config แล้วรันซ้ำ
