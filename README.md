...
[![Update hourly](https://github.com/<OWNER>/<REPO>/actions/workflows/update_hourly.yml/badge.svg)](https://github.com/<OWNER>/<REPO>/actions/workflows/update_hourly.yml)
[![Update daily](https://github.com/<OWNER>/<REPO>/actions/workflows/update_daily.yml/badge.svg)](https://github.com/<OWNER>/<REPO>/actions/workflows/update_daily.yml)
[![Update weekly COT](https://github.com/<OWNER>/<REPO>/actions/workflows/update_weekly_cot.yml/badge.svg)](https://github.com/<OWNER>/<REPO>/actions/workflows/update_weekly_cot.yml)
...
🔗 **[เปิด dashboard](https://<OWNER>.github.io/<REPO>/)**

> ⚠️ ข้อมูลเพื่อการศึกษาเท่านั้น ไม่ใช่คำแนะนำการลงทุน

*(แทน `<OWNER>/<REPO>` ด้วยของจริงหลัง deploy — ดู [DEPLOY_CHECKLIST.md](DEPLOY_CHECKLIST.md) ข้อ 10)*
...
ตรวจเร็ว ๆ: เปิด `https://<OWNER>.github.io/<REPO>/data/latest.json` ตรง ๆ
